...
Route::post('/login', [AuthenticatedSessionController::class, 'store'])
 ...
 Route::post('/login/student', [StudentController::class, 'store'])->middleware('guest')->name('login.student');
 Route::post('/logout/student', [StudentController::class, 'destroy'])
                ->middleware('auth:student')
                ->name('logout.student');
 ###########################################################################
 ################################ Teacher Login ###############################
 Route::post('/login/teacher', [TeacherController::class, 'store'])->middleware('guest')->name('login.teacher');
 Route::post('/logout/teacher', [TeacherController::class, 'destroy'])
