...
@section('css')
    @toastr_css
@section('title')
    {{trans('Teachers_trans.title_page')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th>{{trans('Teachers_trans.Proccess')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php $i = 0; ?>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p> {{ trans('Teachers_trans.Warning_Grade') }}</p>
                                                            <input type="text" Disabled   value="{{$Teacher->Name}}">
                                                            <input type="text" name="idTeachDel"  value="{{$Teacher->id}}">
                                                        </div>
